## Original source code from https://wiki.tcl-lang.org/page/Alternative+JSON
## Modified to support comments
...
proc ::json::decode {json {indexVar {}}} {
    ...
    \" {
        ...
        return -code error "invalid JSON data at index $index: [string index $json $index]"
    }}
